...
namespace Chess
{
	...
	public class ChessMain : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.mnuLoadGame.Text = "&Загрузить игру";
            ...
            this.mnuSaveGame.Text = "&Сохранить игру";
            ...
            this.mnuEditUndoMove.Text = "&Отменить шаг";
            ...
            this.mnuEditRedoMove.Text = "&Повторить шаг";
            ...
            this.mnuShowLog.Text = "Показать лог событий";
            ...
            this.mnuShowMoveHelp.Text = "Подсветка возможных ходов";
            ...
            this.mnuShowComputerThinkDepth.Text = "Показать шаги компьютера";
		...
		{
			GameObj.ShowMoveHelp = !GameObj.ShowMoveHelp;	
			this.mnuShowMoveHelp.Checked = GameObj.ShowMoveHelp;	
		}

		private void TurnTicker_Tick(object sender, System.EventArgs e)
		{
			if (GameObj.IsRunning && !GameObj.IsOver )	
			{
